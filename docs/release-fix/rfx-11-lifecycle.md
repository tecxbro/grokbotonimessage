...
Renewal blocker follow-up commit: `2e388657355b5b0c22842d3c1199f6a67bd3a8bf`. This contains seven new characterization/safeguard tests and the exact blocker/call-site analysis; it does not implement automatic renewal. RFX-00 must keep installation-owner lifetime handling blocked until the authority-transition contract is reviewed. No production source changed.
