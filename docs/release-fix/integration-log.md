...
## RFX-06 integration checkpoint

Reviewed SHA: `b9be4107fbe013602964124242604fc176582262`. Adopt the reviewed complete metadata and payload contract in historical synthetic installer fixtures without deleting failure assertions. Synchronize exact artifact dependency validation with the reviewed RFX-08 direct pins and include the RFX-04 Photon CLI installer in the archive support list.

- `packages/photon-features/scripts/package.mjs` — RFX-06: Adopt the reviewed complete metadata and payload contract in historical synthetic installer fixtures without deleting failure assertions. Synchronize exact artifact dependency validation with the reviewed RFX-08 direct pins and include the RFX-04 Photon CLI installer in the archive support list. Covered by `rfx06-verified` below.
- `packages/photon-features/tests/artifact/rfx-owner-package.test.mjs` — RFX-06: Adopt the reviewed complete metadata and payload contract in historical synthetic installer fixtures without deleting failure assertions. Synchronize exact artifact dependency validation with the reviewed RFX-08 direct pins and include the RFX-04 Photon CLI installer in the archive support list. Covered by `rfx06-verified` below.
- `packages/photon-features/tests/e2e/install-rollback.test.ts` — RFX-06: Adopt the reviewed complete metadata and payload contract in historical synthetic installer fixtures without deleting failure assertions. Synchronize exact artifact dependency validation with the reviewed RFX-08 direct pins and include the RFX-04 Photon CLI installer in the archive support list. Covered by `rfx06-verified` below.
- `packages/photon-features/tests/integration/completion-browser.test.mjs` — RFX-06: Adopt the reviewed complete metadata and payload contract in historical synthetic installer fixtures without deleting failure assertions. Synchronize exact artifact dependency validation with the reviewed RFX-08 direct pins and include the RFX-04 Photon CLI installer in the archive support list. Covered by `rfx06-verified` below.
- `packages/photon-features/tests/lanes/wt-08/distribution.test.mjs` — RFX-06: Adopt the reviewed complete metadata and payload contract in historical synthetic installer fixtures without deleting failure assertions. Synchronize exact artifact dependency validation with the reviewed RFX-08 direct pins and include the RFX-04 Photon CLI installer in the archive support list. Covered by `rfx06-verified` below.
...
## Assembled Linux validation deadline
